...
let strings = "kavak";
let palindromeStr = strings.split("").reverse().join("");


// console.log(string); for debugging purpose
if (strings === palindromeStr) {
  console.log(`${palindromeStr}, Palindrome string.`);
} else {
  console.log(`${strings}. not palindrome string.`);
}
...
console.log(
  original == reverseNum ? "Palindrome number" : "NOt Palidrome Number"
);
